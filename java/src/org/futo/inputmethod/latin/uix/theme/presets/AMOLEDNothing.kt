...
private val nothing_white = Color(0xFFFFFFFF)
...
val AMOLEDNothing = ThemeOption(
    dynamic = false,
    key = "AMOLEDNothing",
    name = R.string.amoled_nothing_theme_name,
    available = { true }
) {
    colorScheme
}
